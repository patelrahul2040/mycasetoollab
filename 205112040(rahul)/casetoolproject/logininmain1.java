...
public void logininmain3()
      {
                ...
                jPasswordField1=new JPasswordField(); 
                   ...
                   add(b1);
            JLabel l6=new JLabel(new ImageIcon("13.png"));
                   l6.setSize(470,400); 
                   l6.setLocation(-2,-50);
                   add(l6);
...
class myclientapp2 extends JFrame implements ActionListener
{
  ...
  public void show1()
  {
       ...
       label1=new JLabel("ONLINE FOOD COUPONS DISTRIBUTION");
                ...
                footer=new JLabel("Rahul kumar patel"); 
                  footer.setSize(150,50);
                  footer.setLocation(749,450);
                  add( footer);
                              
     getContentPane().add(footer, BorderLayout.EAST);
     ...
     timer.start();
         ...
         JLabel l7=new JLabel(new ImageIcon("15.png"));
                l7.setSize(700,300); 
                l7.setLocation(120,120);
                add(l7);
            ...
            JLabel l6=new JLabel(new ImageIcon("9.png"));
                 l6.setSize(1150,540); 
                 l6.setLocation(-130,-50);
                 add(l6);
       ...
       head=new JLabel("WELCOME TO NITT HOTEL OFFICE");
           ...
           l2=new JLabel("Year ");      
             ...
             b1=new JButton("Submit");
                 ...
                 JLabel l6=new JLabel(new ImageIcon("8.png"));
                l6.setSize(800,700); 
                l6.setLocation(-1,-1);
 ...
 public void actionPerformed(ActionEvent e)
 {
  ...
  else if(e.getSource()==b1)
     {
        ...
        if(t1.length()==0||t2.length()==0||t3.length()==0||t4.length()==0)
          ...
          {
             JOptionPane.showConfirmDialog(null,"Sorry roll no must be in nine digit","Status",JOptionPane.ERROR_MESSAGE);
          }
         else 
          {
                        try{
   ...
   extrafoodRegistration(String title)
      {
           ...
           Font f=new Font("courier",Font.ITALIC|Font.BOLD,15);
             ...
             getContentPane().add(veg, BorderLayout.EAST);
             javax.swing.Timer timer1 = new javax.swing.Timer(300, this);
             timer1.start();
     ...
     getContentPane().add( nonveg, BorderLayout.EAST);
     javax.swing.Timer timer = new javax.swing.Timer(300, this);
     timer.start();
        ...
        JLabel l6=new JLabel(new ImageIcon("14.png"));
                l6.setSize(830,600); 
                l6.setLocation(-20,-20);
                add(l6);
...
public void actionPerformed(ActionEvent e)
{
      ...
      String oldText1 = nonveg.getText();
      String newText1 = oldText1.substring(1) + oldText1.substring(0, 1);
      nonveg.setText(newText1);
 

       String oldText =veg.getText();
       String newText = oldText.substring(1) + oldText.substring(0, 1);
       veg.setText(newText);
...
extrafood(String title)
    {
            ...
            b1.addActionListener(this);
                ...
                JLabel l6=new JLabel(new ImageIcon("7.png"));
                l6.setSize(800,500); 
                l6.setLocation(-1,-1);
                add(l6);
...
public void actionPerformed(ActionEvent e)
 {
        ...
        if(e.getSource()==b2)
      ...
      else if(e.getSource()==b1)
         {
               ...
               try{
                           String t1=tx1.getText(),t2=tx2.getText(),t4=tx4.getText(),t3=tx3.getText();
           	
                       if(t1.length()!=0||t2.length()!=0||t4.length()!=0||t3.length()!=0)
                         {
               ...
               if(modifiedSentence.equals("ok"))
                {
                                 ...
                                 JOptionPane.showConfirmDialog(null,"Enjoy Your favourite Food","STATUS",JOptionPane.INFORMATION_MESSAGE);
                                 tx1.setText(" ");
                                 tx2.setText(" ");
                                 tx4.setText(" ");
                }
...
coupons(String title)
    {
        ...
        JLabel l6=new JLabel(new ImageIcon("6.png"));
                l6.setSize(460,250); 
                l6.setLocation(380,84);
                add(l6);
           ...
           JLabel ll=new JLabel(new ImageIcon("14.png"));
                  ll.setSize(830,600); 
                  ll.setLocation(-20,-20);
                  add(ll);
...
public void actionPerformed(ActionEvent e)
   {
        ...
        if(e.getSource()==b2)
      ...
      else if(e.getSource()==b1)
           {
         	    ...
         	    String t1=tx1.getText(),t2=tx2.getText(),t4=tx4.getText();
           	
             if(t1.length()==0||t2.length()==0||t4.length()==0)
                  {
                      JOptionPane.showConfirmDialog(null,"Sorry null values are not Allowed","Status",JOptionPane.ERROR_MESSAGE);
                      tx1.setText(" ");tx2.setText(" ");tx4.setText(" ");
                  }
             else if(t1.length()<9&&t1.length()>12)
                  {
                      JOptionPane.showConfirmDialog(null,"Sorry registration no is too short ","Status",JOptionPane.ERROR_MESSAGE);
                  }
               else 
                  {
                        try{
